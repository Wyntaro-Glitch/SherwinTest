  ...
  return (
    <div className="w-64 bg-slate-950 border-r border-slate-900 flex flex-col p-4 gap-6 select-none shrink-0 h-full" role="navigation" aria-label="Mail sidebar">
      ...
      <div className="flex flex-col gap-1.5 pt-4 border-t border-slate-900">
        ...
        >
          <svg
            className={`w-5 h-5 ${currentFolder === "home" ? "text-indigo-400" : "text-slate-500"}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <button
          onClick={() => setCurrentFolder("resume")}
          className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all duration-150 cursor-pointer ${
        ...
        >
          <svg
            className={`w-5 h-5 ${currentFolder === "resume" ? "text-indigo-400" : "text-slate-500"}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <button
          onClick={() => setCurrentFolder("ai-models")}
          className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all duration-150 cursor-pointer ${
        ...
        >
          <svg
            className={`w-5 h-5 ${currentFolder === "ai-models" ? "text-indigo-400" : "text-slate-500"}`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
